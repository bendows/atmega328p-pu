...
Connect an external 16MHz crystal to pins 9 and 10 if the Atmega328p-pu is set to use an external crystal.
I did not need to connect two 22pF caps from pin 9 to GND and from PIN 10 to GND when using 
